 ...
 *
 */
abstract class WTableNested extends JTableNested {
     ...
     */
    public function loadFromPath($alias = null, $grouping = array(), $reset = true) {
    ...
    public function store($updateNulls = false)
    {
        ...
        {
            $this->setLocation($this->parent_id, 'first-child');
        }
