        ...
        <fieldset class="adminform">
            <table  class="admintable">
                <tr>
                    ...
                    <?php if (!$knowledgeDomain->id || $this->getModel('canChangeState')): ?>
                    <td class="key">
                        <label>
                    ...
                    <td>
                        <select class="inputbox" name="published" id="published">
                            <option <?php echo ($knowledgeDomain->published == 1) ? 'selected="selected"' : ''; ?> value="1">Published</option>
                            <option <?php echo ($knowledgeDomain->published == 0) ? 'selected="selected"' : ''; ?> value="0">Unpublished</option>
                        </select>
                    </td>
                    <?php endif; ?>
                </tr>
