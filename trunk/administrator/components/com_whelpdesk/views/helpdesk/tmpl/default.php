    ...
    <tbody>
        <tr>
                    ...
                    <div style="float: left;">
                        <div class="icon">
                            <a href="<?php echo JRoute::_('index.php?option=com_whelpdesk&task=faqcategories.list'); ?>">
                                <img alt="<?php echo JText::_('FAQ CATEGORIES'); ?>" src="/WATS/svn_4.0/administrator/templates/khepri/images/header/icon-48-article-add.png"/>
            ...
            <td width="45%" valign="top">
                <div class="pane-sliders" id="content-pane">Sliders go here</div>
            </td>
        </tr>
    </tbody>
</table>