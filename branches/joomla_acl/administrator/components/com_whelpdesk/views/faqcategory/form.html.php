...
class FaqcategoryHTMLWView extends WView {
    ...
    private function document() {
        ...
        WDocumentHelper::addPathwayItem(JText::_('WHD_FC:FAQ CATEGORIES'), null, 'index.php?option=com_whelpdesk&task=faqcategories.list');
        ...
        if ($category->getValue('id'))
        {
            ...
            // set the subtitle
            WDocumentHelper::subtitle(JText::sprintf('WHD_FC:EDIT FAQ CATEGORY %s', $category->name));
        }
        else
        {
            WDocumentHelper::addPathwayItem(JText::_('WHD_FC:NEW FAQ CATEGORY'));
            WDocumentHelper::subtitle(JText::_('WHD_FC:NEW FAQ CATEGORY'));
        }
    }
