...
# USER
WATS_USER=Užívate¾
WATS_USER_SET=Užívatelia
WATS_USER_NAME=Meno
WATS_USER_USERNAME=Užív. meno
WATS_USER_GROUP=Skupina
WATS_USER_ORG=Firma
WATS_USER_ORG_SELECT=Zadajte firmu
WATS_USER_EMAIL=Email
WATS_USER_NEW=Vytvori? nového užívat.
WATS_USER_NEW_SELECT=Vybra? užívate¾a
WATS_USER_NEW_CREATED=Vytvorení užívatelia
WATS_USER_NEW_FAILED=Tento užívate¾ už má úèet:
WATS_USER_DELETED=Užívate¾ zmazaný
WATS_USER_EDIT=Upravi? užívate¾a
WATS_USER_DELETE_REC=Odstráni? Tickety užívate¾a (doporuèené)
WATS_USER_DELETE_NOTREC=Odstráni? Tickety užívate¾a aj jeho odpovede na iné tickety (nedoporuèené)
WATS_USER_DELETE=Vymaza? užívate¾a
WATS_USER_ADD=Prida? užívate¾a
WATS_USER_SELECT=Oznaè užívate¾a
WATS_USER_SET_DESCRIPTION=Spravovanie užívate¾ov
WATS_USER_ADD_LIST=Nasledovní užívatelia boli pridaní
...
WATS_TICKETS_POSTS=Založené
WATS_TICKETS_DATETIME=Posledný zápis
WATS_TICKETS_PAGES=Strany
WATS_TICKETS_SUBMIT=Založi? nový ticket
WATS_TICKETS_SUBMITING=Zakladanie ticketu
WATS_TICKETS_SUBMITTED=Ticket je založený
WATS_TICKETS_DESC=Popis
WATS_TICKETS_CLOSE=Zatvori? Ticket
WATS_TICKETS_CLOSED_COMP=Ticket zatvorený
WATS_TICKETS_DELETED_COMP=Ticket vymazaný
WATS_TICKETS_PURGED_COMP=Ticket uvo¾nený
...
//MAIL
WATS_MAIL_TICKET=Ticket vložený:
WATS_MAIL_REPLY=Odpoveï vložená:
...
WATS_ERROR_ACCESS=Nemáte dostatoèné práva ukonèi? túto požiadavku
WATS_ERROR_NOUSER=Nie ste autorizovaný na prezeranie týchto zdrojov.<br>Je nutné sa prihlási? alebo požiada? administrátora o prístup.
WATS_ERROR_NODATA=Nevyplnili ste správne formulár, prosím skúste to znovu.
WATS_ERROR_NOT_FOUND=Položka neexistuje

//BBCODE
WATS_BB_HELP=<p><i>Použite nasledovné 'znaèky' pre uèeli formátovania vašeho textu:</i></p>
